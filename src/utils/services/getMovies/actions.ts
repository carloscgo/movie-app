 ...
 * @return {object} { type }
 */
export const getMoviesRequestAction = ({ offset, limit, genreId, title }: any) => ({
 ...
 */
export const getMoviesSuccessAction = (data: any) => ({
 ...
 * @return {object} { type, data }
 */
export const getMoviesFavoriteAction = ({ data }: any) => ({
 ...
 * @return {object} { type, data }
 */
export const getMoviesUnfavoriteAction = ({ data }: any) => ({
 ...
 * @return {object} { type, data }
 */
export const getMoviesDeleteAction = ({ data }: any) => ({
 ...
 * @return {object} { type, data }
 */
export const getMoviesUndeleteAction = ({ data }: any) => ({
 ...
 * @return {object} { type, data }
 */
export const getMoviesAddAction = ({ data }: any) => ({
